  ...
  <main class="cd-main-content">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="modal fade" id="modalcriarsenha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalcriarsenha">Criar Senha</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <?php
              require('criar_senha.php');
              ?>
            </div>
          </div>
        </div>
        ...
        <table class="table table-bordered table-striped" id="tabela"> 
          ...
          <tbody>
           ...
           while ($i < count($linha)) {
            ...
            <td><?php 
            if($linha[$i]['nivel'] == 1){echo "Administração";} 
            if($linha[$i]['nivel'] == 2){echo "Juizes";} 
            if($linha[$i]['nivel'] == 3){echo "Relações Públicas";} 
            if($linha[$i]['nivel'] == 4){echo "Somente Visualizar agenda";} 
            ...
            <a style="<?php echo $style ?>" data-toggle="tooltip" data-placement="top" onclick="return confirm('Tem certeza que deseja excluir?');" class="btn btn-danger btn-lg" title="Excluir" href="classes/servidor_delete.php?id=<?php echo $linha[$i]['id']?>"> 
            ...
            //{
            //  ?>
              <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#modalalterarsenha" 
              data-id="<?php echo $linha[$i]['id']; ?>" 
              data-nome="<?php echo $linha[$i]['nome']; ?>" 
              data-telefone="<?php echo $linha[$i]['telefone']; ?>" 
              data-cpf="<?php echo $linha[$i]['cpf']; ?>"
 ...
 <script src="js/jquery.maskedinput.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
   $('#fechar-mensagem').on("click", function() {
    window.location.href = "listar_servidores.php";
