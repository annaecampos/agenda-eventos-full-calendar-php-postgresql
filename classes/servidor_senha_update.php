...
$obj = new Crud_Pessoa();
 ...
 $troca_senha = $obj->login_select_troca_senha($login, $senha, $id);
 $tipopessoa=1;

//echo count($troca_senha);

if(($senha_nova=="") && ($senha_confirma=="") && ($senha==""))
{
...
else
{
	...
	else
	{
		...
		$senha_banco = count($troca_senha);
		if($senha_banco == 0)
		{
			$url='../listar_servidores.php?erro_senha_atual';
        	echo("<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=$url'>");
