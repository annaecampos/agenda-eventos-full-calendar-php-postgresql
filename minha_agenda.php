...
$linha =$obj->evento_select_table_minhaagenda($idpessoa);
$campoalterar = $obj->evento_select($id);
...
<head>
  ...
  drop: function(date) {
   ...
   $.ajax({
    url: 'classes/evento_insert_minha_agenda2.php',
    type: "POST",
    data: {Event:Event},
    success: function(rep) {
      if(rep == 'OK'){
        ...
        window.location.href = 'minha_agenda.php';
...
<body class="bg-light" id="bminhaagenda">
 <main class="cd-main-content">
  <div class="content-wrapper">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h4 class="h4">Minha Agenda </h4>
...
<!--POPUPS -->
<?php
require('minha_agenda_visualizar.php');

require('minha_agenda_cadastrar.php');
?>
<!--FIM POPUPS -->
