...
<div class="modal-body">
	<form class="needs-validation" method="POST" novalidate action="classes/servidor_senha_update.php" enctype="multipart/form-data">
		...
		<input type="hidden" class="form-control" name="idsetor" id="idsetor" placeholder="" required>
				<input type="hidden" class="form-control" name="nivel" id="nivel" placeholder="" required>
		<div class="mb-3">
